...
import featImg1 from 'common/assets/image/webAppCreative/featureIcon-1.svg';
import featImg2 from 'common/assets/image/webAppCreative/featureIcon-2.svg';
import featImg3 from 'common/assets/image/webAppCreative/featureIcon-3.svg';
import featImg4 from 'common/assets/image/webAppCreative/featureIcon-4.svg';
import featImg5 from 'common/assets/image/webAppCreative/featureIcon-5.svg';
import featImg6 from 'common/assets/image/webAppCreative/featureIcon-6.svg';
...
export const menu_items = [
  ...
  {
    label: 'Mòduls i característiques',
    path: '#features',
    offset: '70',
  },
  {
...
export const howTos = [
  {
    id: 1,
    icon: icon1,
    title: 'Interessant i accesible per als ciutadans',
    text: `Tota l’actualitat municipal amb noticies, avisos i enquestes ara més visibles i accesible per tots els teus ciutadans.`,
  ...
  },
  {
    id: 2,
    icon: icon2,
    title: 'Eficient i pràctica per als ajuntaments',
    text: `Una àmplia varietat de sol·lucions integrades per informar als ciutadans i rebre el feedback que necessites del teu municipi.`,
    linkLabel: 'Learn More',
    link: '#',
  },
  {
  ...
  tabs: [
    {
      ...
      title: 'Dashboard',
      content: {
        description: 'Descripción de la pestaña que se muestra en este momento.',
        image: dashboardImg,
      },
    },
    {
...
export const footer = {
  copyright: `Copyright © ${new Date().getFullYear()} Adaptive Technology S.L. All rights reserved`,
  nav: [
    {
      id: 1,
      title: 'Support',
